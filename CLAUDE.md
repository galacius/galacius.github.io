...
Minimal React 19 + TypeScript + Vite landing page for Galacius, styled with Tailwind CSS v4 (via `@tailwindcss/vite`, no `tailwind.config`/PostCSS setup needed).
...
- All UI is built on `@galacius/design-system` — see **[DESIGN.md](./DESIGN.md)** for the required setup, import conventions, and styling rules before adding components.
