...
Thanks for helping improve the Galacius landing page. This guide covers local setup, the tools this project uses, and how to submit changes.
...
See [CLAUDE.md](./CLAUDE.md) for an architecture overview and [DESIGN.md](./DESIGN.md) for design system conventions — read DESIGN.md before adding or changing any UI, as all components must be built on `@galacius/design-system`.
